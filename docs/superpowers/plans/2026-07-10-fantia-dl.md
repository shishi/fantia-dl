...
```json
{
  "post": {
    ...
    "fanclub": { "id": 1234, "creator_name": "sample_creator", "fanclub_name": "サンプルファンクラブ" },
    "post_contents": [
      {
        "id": 42, "title": "ギャラリー", "category": "photo_gallery", "visible_status": "visible",
...
```json
{
  "post": {
    ...
    "post_contents": [
      {
        "id": 43, "title": "", "category": "file", "visible_status": "visible",
        "plan": { "name": "無料プラン", "price": 0 },
        "filename": "video_a.mp4",
        "download_uri": "/posts/2345678/download/43"
      }
    ]
  }
}
